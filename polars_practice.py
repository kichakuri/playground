...
def get_revenue_by_month():
    ...
    data = filtered_by_amount.with_columns(pl.col('Invoice Amount').cast(pl.Float32))
    ...
    revenue_amt_by_month = revenue_grouped_by_month.agg(pl.sum('Invoice Amount')).sort(by='Inv_MM', descending=False)
